...
- 📚 Currently learning how to use Sidekiq (background tasks) and AWS's S3 together for image hosting, embedded IOT development via arduino C++ with wifi enabled microcontrollers using various sensors, docker, React.js, and CSS flexbox.
